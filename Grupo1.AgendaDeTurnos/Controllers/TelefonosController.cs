...
namespace Grupo1.AgendaDeTurnos.Controllers
{
    public class TelefonosController : Controller
    {
        ...
        public TelefonosController(AgendaDeTurnosDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NumeroCelular,TelefonoAlternativo")] Telefono telefono)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NumeroCelular,TelefonoAlternativo")] Telefono telefono)
        {
            if (id != telefono.Id)
            {
                return NotFound();
