...
namespace Grupo1.AgendaDeTurnos.Controllers
{
    public class AdministradoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Dni")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Dni")] Administrador administrador)
        {
