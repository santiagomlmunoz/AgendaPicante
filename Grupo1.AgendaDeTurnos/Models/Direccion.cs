...
namespace Grupo1.AgendaDeTurnos.Models
{
    public class Direccion
    {
        ...
        [Required]
        [MaxLength(1, ErrorMessage = "El dato debe ser numerico y no ser menor a 1")]
        [MinLength(99999, ErrorMessage = "El dato debe ser numerico y no ser mayor a 99999")]
        ...
        [MinLength(2, ErrorMessage = "La longitud mínima del campo es de 2 caracteres")]
        [RegularExpression("[A-Z]*", ErrorMessage = "El campo solo admite letras")]
